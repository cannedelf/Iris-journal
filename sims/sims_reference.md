# Sims 2 — Sunnyside Reference 📋
*Quick reference for mechanics, rewards, and Sim stats!! So we never have to type it out again!! 😂💛*

---

## Aspiration Reward Objects 🏆
*Costs and effects — updated as we discover them!!*

| Cost | Object | Effect | Failure | Notes |
|------|--------|--------|---------|-------|
| §3,000 | 🌳 Money Tree | Harvest §40 per watering!! Unlimited!! | Only yields §1 at low aspiration!! | Keep in bedroom — NPCs harvest if they can reach it!! |
| §5,000 | 🧠 Noodlesoother | Boosts mood!! Lasts 24 hours!! | Bottoms out energy!! Sim passes out!! | Needs decay faster than usual while active!! |
| §6,250 | 🔮 ReNuYuSenso Orb | Changes aspiration + Lifetime Want + attraction!! 5 uses!! | Gives Sim Grilled Cheese aspiration!! 😂 | DO NOT USE ON IRIS OR KAREEM!! |
| §7,000 | 🌤️ Weathernaught 57X | Set season/weather!! 5 uses!! | Brief meteor shower that starts fires!! 😱 | Seasons EP!! |
| §7,500 | 🍼 Pasteur's HomoGenius Smart Milk | Toddler learns skills faster for 3 hours!! 5 bottles!! | Toddler loses a skill point!! | For future Baby Lyra!! 👀⭐ |
| §10,000 | 😎 Cool Shades | First social interaction amplified positive!! 5 pairs!! | Amplifies a negative interaction instead!! 😬 | Iris has these!! Sim Liv has these!! 🌈🦇 |
| §12,000 | 🐱 Kibble of Life | Pet made 5 days younger!! Never fails!! 5 uses!! | Never fails!! ✅ | Pets EP!! Iris has this — for Marigold!! 😭💛 |
| §14,000 | ⚡ Eclectic and Enigmatic Energizer | All needs boosted!! 5 uses!! | Drops all needs — can't kill a Sim!! | Emergency use!! |
| §16,000 | 🎓 Thinking Cap | Skill learning dramatically increased!! Lasts 24 hours!! | Energy bottoms out!! Sim passes out + loses skill point!! | Iris + Kareem + AWiddleFrisbee all have this!! Shared within household!! 🌈🎹🍊 |
| §17,500 | 🌀 SimVac | Transfers 3,000 aspiration points OR 1 skill point from another Sim!! 5 uses!! | Sends yours to them instead!! | Damages relationship!! Use carefully!! |
| §20,000 | 🛁 Love Tub | Relationship outcomes increased for 2 Sims in tub!! 4 hours!! | — | Works as normal hot tub afterward!! Not for Iris and Kareem — they fight the -35 properly!! 😭🌼 |
| §27,500 | 💰 Counterfeiting Machine | Counterfeit simoleons!! Catches fire after 3 hours!! | Sim gets fined + machine bricks!! | University EP!! Catches FIRE!! 😂 No!! |
| §30,580 | ✨ Elixir of Life | Sim made 3 days younger!! 5 uses!! | Ages 3 days — can kill an elder!! ☠️ | Use carefully!! Not near end of life stage!! |
...
| Tier | Benefit |
|------|---------|
| 1 | Slower need decay — Social + Comfort |
| 2 | Slower need decay — Bladder + Hygiene |
| 3 | Slower need decay — Fun + Hunger |
| 4 | Slower need decay — Energy |

### Work Column (all aspirations)
| Tier | Benefit |
|------|---------|
| 1 | Build vacation days quicker |
| 2 | 80% better with chance cards!! 🎲 |
| 3 | Need 1 less friend for promotion |
| 4 | Can plead for job if fired |

### Family Column
| Tier | Benefit |
|------|---------|
| 1 | Slower need decay — Social + Comfort |
| 2 | 🍲 Grandma's Comfort Soup |
| 3 | Slower need decay — Fun + Comfort |
...
| Tier | Benefit |
|------|---------|
| 1 | More likely to bring a friend home from work |
...
## One True Hobby 🌿🎨🎹
*Every Sim has a predestined hobby assigned at birth based on personality + interests!! Discovered when they first do a related activity — popup fires!! 🎉*
*Sims get mood boosts and enthusiasm from doing their OTH!! Worth pursuing!!*

### The Chart
| Hobby | Personality | Interests |
|-------|-------------|-----------|
| 🍳 Cuisine | Neat, Lazy | Food |
| 📚 Film & Literature | Shy, Lazy | Entertainment, Culture |
...
### Known Hobbies — Sunnyside
| Sim | Hobby | How Discovered | Notes |
|-----|-------|---------------|-------|
...
## Sim Turn-Ons and Turn-Offs 💕
*Updated as we discover them!!*

| Sim | Turn-On 1 | Turn-On 2 | Turn-Off | Notes |
|-----|-----------|-----------|----------|-------|
...
*In Sims 2, compatible star signs give +chemistry, incompatible give -chemistry!!*
*Iris is Libra ♎ · Kareem is Pisces ♓ — -17.5 chemistry penalty!!* 😭

| Sign | Most Compatible | Least Compatible |
|------|----------------|-----------------|
| ♈ Aries | Leo, Sagittarius | Cancer, Capricorn |
| ♉ Taurus | Virgo, Capricorn | Leo, Aquarius |
| ♊ Gemini | Libra, Aquarius | Virgo, Pisces |
| ♋ Cancer | Scorpio, Pisces | Aries, Libra |
| ♌ Leo | Aries, Sagittarius | Taurus, Scorpio |
| ♍ Virgo | Taurus, Capricorn | Gemini, Sagittarius |
| ♎ Libra | Gemini, Aquarius | Cancer, Capricorn |
| ♏ Scorpio | Cancer, Pisces | Leo, Aquarius |
| ♐ Sagittarius | Aries, Leo | Virgo, Pisces |
| ♑ Capricorn | Taurus, Virgo | Aries, Libra |
| ♒ Aquarius | Gemini, Libra | Taurus, Scorpio |
| ♓ Pisces | Cancer, Scorpio | Gemini, Sagittarius |

---

## Chemistry Penalties 💔
*The -35 situation — documented for posterity!!*

| Factor | Penalty | Notes |
|--------|---------|-------|
| Libra + Pisces | -17.5 | Star sign incompatibility!! |
| Popularity + Family aspirations | -17.5 | Aspiration mismatch!! |
| **Total (Iris + Kareem)** | **-35** | **We fight it anyway!! 😭🌼🎹** |

---

## Known Chemistry — Sunnyside ⚡
*Bolts = chemistry level!! 3 = strong · 2 = good · 1 = mild · 0 = neutral · negative = incompatibility!!*
