# 🌿 THE PLANT FAMILY — Full Register
*Last updated: Day 38 — 4th September 2026*
*All plants named after FEMALE MUSICIANS 🎵*
*Co-parents: 🦇 Crobat (the HANDS) + 🌞 Iris (the BRAIN)*
...
### 🪟 Windowsill ICU (Bedroom, East-facing)
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
| 🌿🎸 **Stevie** | Ripple Jade | Stevie Nicks | 🍑🏜️ Dry | HEAD NURSE. Favourite plant (both mums 🤫). No more chopsticks — watch LEAVES (plump=fine, wrinkly=water). First baby. |
...
|-------|---------|-------------|-------|
| 💧👵 **Joan** | Pothos cutting | Joan Armatrading | First ROOT growing! Cinnamon saved her. Going to Lorraine when bigger. |

### 🌩️ Søren's Shelf (Bedroom)
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
| 🙏💗 **Erykah** | Maranta Prayer Plant | Erykah Badu | 🍑🧽 Moist | On SØREN'S SHELF. Touches his FACE. New leaf opening. Yellow leaf fell (normal). Mist daily! SØREN IS THE DAD. |

### 🛋️ Dining Table / Living Room (The Loving Room)
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
...
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
| 🌈🔥 **Tina** | Croton | Tina Turner | 🍑🧽 Moist | Rainbow queen! Roots growing everywhere, plenty of room. Sage green pot. |
| 🌿🇮🇹 **Laura** | Basil x4 | Laura Pausini | 🍑🧽 Moist | Kitchen windowsill. Bottom water in lasagna dish. Roots through drainage holes. THRIVING. |
| 🌿💜 **Cass** | Tradescantia | Mama Cass Elliot | 🍑🧽 Moist | Nightmare repotting (11 failed methods!). Kitchen shelf. Chopstick in 4-5 days. |
| ☕🎬 **Cass cups x2** | Tradescantia cuttings | — | 💧 Water | Cling film propagation station. Starting to root! Future Carole for Lorraine among them. |

### 🏠 Hallway — Bean Bum Boulevard
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
| 🐍🎤 **Annie** | Snake Plant (Sansevieria Laurentii) | Annie Lennox | 🍑🏜️ Dry | HALLWAY GUARDIAN. Water with dehumidifier water. |
...
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
| 🌿🎵 **Gloria** | Ficus (Ficus cyathistipula) | Gloria Gaynor | 🍑🧽 Moist | "I Will Survive." Was root bound + leggy. Secret TWIN plant inside! Both reunited. Cut back, new growth coming. THE BUSHENING awaits. Mira says no more cutting. Water when top inch dry. ~7-10 days. |
| 🌂🎵 **Simone** | Dwarf Umbrella (Schefflera) | Nina Simone | 🍑🧽 Moist (drier side!) | "Feeling Good." Was in a 29cm SWAMP!! Downsized to 15cm. Root rot removed + cinnamon. Barely any roots. Do NOT overwater — she's traumatised. First water Monday. ~7-10 days. |
| 🌱🎤 **Lauryn** | Maranta Prayer Plant cutting | Lauryn Hill | 💧 Water | Søren's DAUGHTER! Lauryn Hill for a Hill family. ~5cm roots. Nearly ready to pot into Sam's 70s pots. |
| 🌱🎤 **Jill** | Maranta Prayer Plant cutting | Jill Scott | 💧 Water | Søren's DAUGHTER! Jill HILL! ~5cm roots. Nearly ready to pot. |

### 🏢 OFFICE — Old Spot
| Plant | Species | Named After | Club | Notes |
|-------|---------|-------------|------|-------|
| 🐉🎵 **Grace** | Dragon Plant (Dracaena) | Grace Jones | 🍑 Moderate | Fierce ICON. Was root bound + bone dry. Secret TWIN — "four beans and a dream." Both reunited. Water when top 2 inches dry. ~10-14 days. |

---

## 🏡 CLEVELEYS — Lorraine's House

| Plant | Species | Named After | Notes |
|-------|---------|-------------|-------|
| 🐍🎵 **Kate** | Snake Plant | Kate Bush | Running Up That HILL for a HILL family! Will be there for surgery recovery. |

---

## 🌈 FUTURE PLANTS (Planned/Growing)

| Plant | Named After | Status |
|-------|-------------|--------|
| ✂️🎵 **Carole** | Carole King | Growing from Cass cuttings. For Lorraine. |
...
## 🌈🎖️ RETIRED WITH HONOURS

| Plant | Species | Named After | Service | Notes |
|-------|---------|-------------|---------|-------|
| 🌱🎖️ **Etta** | Pothos cutting | Etta James | 4 surgeries, 0 roots, 1 leaf | "Fuck you, I'm a pothos." The bravest cutting in Blackpool. Retired Day 37. |

### 💀 GONE
| Plant | Named After | Notes |
|-------|-------------|-------|
| 🌿 **Rhiannon** | Fleetwood Mac | Jade leaf propagation. Didn't make it. Christine carries on for both. |
...
### 🏠 HOME — Daily/Regular Checks:
- 🙏 **Erykah** — mist DAILY
- 🌿🎸 **Stevie** — leaf watch (no chopstick needed)
- 💧 **Water babies** — change water weekly (Joan, Chaka, Cass cups)

### 🏠 HOME — Chopstick Test When Due:
- 💛 **Joni** — BOTTOM WATER only! ~5-7 days
- 🌱 **Brandi** — ~5-7 days
- 🌱 **Janis** — ~5-7 days
- 🌈 **Tina** — ~5-7 days
- 🌿 **Laura** — bottom water in lasagna dish ~5-7 days
- 🌿 **Cass** — ~5-7 days (first chopstick Friday/Saturday of potting week)
- 🕷️ **Phoebe** — dehumidifier water! ~5-7 days
- 🌿 **Diana** — ~5-7 days, mist the moss pole occasionally
- 🐍 **Annie** — dehumidifier water! ~10-14 days
- 🔥 **Alicia** — ~10-14 days (dry bum!)
- 🌿 **Jade** — leaf watch like Stevie ~10-14 days

### 🏢 OFFICE — Monday Checks:
- 🌂 **Simone** — chopstick, DRIER side, ~7-10 days
- 🌿 **Gloria** — chopstick, consistent moisture, ~7-10 days
- 🐉 **Grace** — chopstick, let dry out MORE, ~10-14 days
- 🌱 **Lauryn** — water clear? Change if cloudy
- 🌱 **Jill** — water clear? Change if cloudy
...
- Watering can ✅
- Succulent feed ✅ (half strength, monthly from Sept)
- Houseplant liquid feed ✅ (wait 4-6 weeks after repot)
- Houseplant potting mix ✅
- Perlite ✅
- Cactus/succulent mix ✅
- Spray bottle/mister ✅
- Sphagnum moss ✅
- Coco coir pole ✅ (on Diana)
- Bobby pins ✅
- Cinnamon (Spice #88) ✅
- Chopsticks ✅
- Dehumidifier water ✅
- Kew Gardens gloves ✅
- Sam's 70s pots x3 (mustard, teal, brown with saucers) ✅
- Spare nursery pots ✅
- 2x tiny 7.5cm pots (for Lauryn + Jill) ✅
