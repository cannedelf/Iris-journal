// Thin wrapper around the GitHub Contents API for the Sunshine Budget Tracker.
// Same pattern as the Sunnyside app: read and write a single JSON data file straight
// back to the repo, so every logged spend is committed with full version history.
// The access token lives only in this browser (localStorage) — never in the repo.
...
// e.g. https://cannedelf.github.io/iris-journal/budget/  ->  owner "cannedelf", repo "iris-journal".
function detectRepo() {
